...
export class AlphalendClient {
   ...
   * @param params.claimAlpha Whether to claim and deposit Alpha token rewards (deprecated. Use claimAndDepositAlpha instead)
   * @param params.claimAll Whether to claim and deposit all other reward tokens (deprecated. Use claimAndDepositAll instead)
